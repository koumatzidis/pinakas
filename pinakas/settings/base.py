...
BASE_DIR = __Path(__file__).resolve().parent.parent
...
ROOT_URLCONF = 'pinakas.urls'
WSGI_APPLICATION = 'pinakas.wsgi.application'
...
STATIC_URL = '/static/'
STATIC_ROOT = str(__Path(BASE_PATH, 'staticfiles'))
STATICFILES_DIRS = [
    BASE_DIR / 'static',  # Ensure this is the path to the 'static' folder containing 'css'
     #__Path(BASE_PATH, 'static')
]

MEDIA_URL = '/media/'
MEDIA_ROOT = __os.path.join(BASE_DIR, "static")
#MEDIA_ROOT = __os.path.join(BASE_DIR, 'media')
...
AdminSite.site_title = _("Pinakas")
AdminSite.site_header = _("Pinakas - Information management software")
AdminSite.index_title = _("Administration of Pinaka")
