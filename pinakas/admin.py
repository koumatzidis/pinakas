...
from .models import Announcement, Configuration, Media, Planning, Room, Teacher, Time, Day,SchoolProgramme,DutyTime, DutyLocation, DutyAssignment
...
# Admin interface for the planning and generalplanning
class PlanningAdmin(admin.ModelAdmin):
    ...
    def delete_all(self, request, queryset):
        ...
        return redirect("admin:pinakas_planning_changelist")
...
@admin.register(SchoolProgramme)
class SchoolProgrammeAdmin(admin.ModelAdmin):
    list_display = ('day', 'room', 'time', 'teacher')
    list_filter = ('day', 'room', 'teacher')

@admin.register(DutyTime)
class DutyTimeAdmin(admin.ModelAdmin):
    list_display = ['name', 'is_for_duty']
    list_filter = ['is_for_duty']
...
class DutyAssignmentAdmin(admin.ModelAdmin):
    list_display = ['type', 'day', 'time', 'location', 'teacher']
    list_filter = ['type', 'day', 'location', 'time']